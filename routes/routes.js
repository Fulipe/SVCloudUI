...
router.get('*', async (req,res) =>{
    const directoryPath = path.join(root, req.path); //isto é o "handler" das routes
    ...
    try{
        ...
        if (stat.isDirectory()){
            ...
            res.render('index', {items, formattedItems, caminho:req.path, anterior:parentPath, emptyDirMsg});
